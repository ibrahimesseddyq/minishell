...
/*   Updated: 2024/10/28 05:53:21 by ibes-sed         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_a_special_case(char *cmd, struct stat *sb)
{
	if (!ft_strcmp(cmd, "..") || !ft_strcmp(cmd, ".")
		|| (cmd[ft_strlen(cmd) - 1] == '/' && S_ISDIR(sb->st_mode))
